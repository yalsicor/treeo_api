...
/**
 * Class ExtractFlickrHotspotsImagesCommand
 *
 * @author Sebastian Weckend <sebastian.weckend@posteo.de>
 */
class ExtractFlickrHotspotsImagesCommand extends ConsoleCommand
{
     ...
     * @var string
     */
    protected $signature = 'treeo:flickr:hotspot';
     ...
     * @var string
     */
    protected $description = 'Extract hotspot data from flickr and save it locally.';

    private $flickrApi;

    private $ErrorFile = "flickr/hotspot_invalid.txt";
    ...
    {
        //albums
        $this->info('Extracting hotspot albums...');

        //get all plots with flickr_album
        $albums = Hotspot::whereNotNull('flickr_album')->get();

        $this->info("{$albums->count()} hotspots with flickr album found.");
        ...
        //photos
        $photos = Hotspot::whereNotNull('flickr_photo')->get();

        $this->info("{$photos->count()} hotspots with flickr photo found.");
